...
export function SeoCtaBlock({
  ...
  description = "Jump into CV Builder’s free AI resume builder and ship a stronger application today.",
  primaryHref = "/ai-resume-builder-tool",
  primaryLabel = "Open Free AI Resume Builder",
}: SeoCtaBlockProps) {
  const secondaryHref =
    primaryHref === "/cover-letter-generator" ? "/ai-resume-builder-tool" : "/cover-letter-generator";
  const secondaryLabel =
    primaryHref === "/cover-letter-generator"
